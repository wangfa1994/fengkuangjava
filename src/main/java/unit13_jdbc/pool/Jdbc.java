...
public class Jdbc {
    ...
    public static void old() throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/test?useSSL=false&serverTimezone=Hongkong&allowPublicKeyRetrieval=true",
                "root", "root");
    ...
    public static void dbcp() throws Exception{
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/test?useSSL=false&serverTimezone=Hongkong&allowPublicKeyRetrieval=true");
    ...
    public static void c3p0() throws Exception {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/test?useSSL=false&serverTimezone=Hongkong&allowPublicKeyRetrieval=true");
